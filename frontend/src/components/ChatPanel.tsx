          ...
          <div className="flex gap-1.5 items-center pb-0.5">
            ...
            {isLoading ? (
              ...
              <button
                ...
                disabled={!input.trim()}
                className="p-1.5 rounded-lg bg-[var(--color-primary-solid)] hover:bg-[var(--color-primary-active)] text-white disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-200 shadow-[var(--shadow-sm)]"
                aria-label="发送消息"
              >
